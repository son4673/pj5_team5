...
#define FighterWidth 5 //주인공 길이
#define NoMissile 23 //미사일의 Y축 범위
#define NoEnemy 8//한화면 적객체 수

int coin = 0; //이어서 하기 판별
...
int life = 3, bomb = 3; // 초기 life
int stage = 1; // 초기 stage
int kx = 0, ky = 0;
int speed = 7;//초기 speed값 작아질수록 빨라짐
int enemy_draw = 0; //적객체 갯수
